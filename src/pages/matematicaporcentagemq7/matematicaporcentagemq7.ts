...
import { Matematicaporcentagemq7gabPage } from '../matematicaporcentagemq7gab/matematicaporcentagemq7gab';
/**
 * Generated class for the Matematicaporcentagemq7Page page.
 *
...
@IonicPage()
@Component({
  selector: 'page-matematicaporcentagemq7',
  templateUrl: 'matematicaporcentagemq7.html',
})
export class Matematicaporcentagemq7Page {
  timerVar;
  timerVal;
  ...
  resposta (){
    if (this.buttonColorB == '#2196F3' && this.ops !== "Oops! Vamos tentar de novo" && this.ops !== "Resposta incorreta, vamos fazer outro exercício para melhorarmos!" ){ //acertou sem dica
      ...
      let alert = this.alertCtrl.create({
        title: 'Dica',
        subTitle: '60% dos pacientes não foram curados pelo método tradicional e foram divididos em dois grupos iguais, cada um com um tratamento e cura diferente.',
        buttons: ['OK'] });
      alert.present();
      ...
      this.navCtrl.push(Matematicaporcentagemq7gabPage);
  }
